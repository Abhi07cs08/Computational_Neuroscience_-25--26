...
python -u "/home/kostouso/CompNeuro/Computational_Neuroscience_-25--26/scripts/train_simclr.py" --imagenet_root /home/kostouso/CompNeuro/Computational_Neuroscience_-25--26/split_data --batch_size $batch_size --epochs $epochs --save_dir "/scratch/kostouso/CompNeuro/Computational_Neuroscience_-25--26/Jan_18_launch/sk_logs_spec_loss_${spectral_loss_coeff}_warmup_${warmup_epochs}_tau_${tau}" --tau $tau --lr $lr --wd 1e-6 --workers 16 --warmup_epochs $warmup_epochs --grad_clip $grad_clip --eval_every 5 --lp_epochs 5 --lp_lr 0.1 --amp --seed 0 --neural_data_dir "/home/kostouso/CompNeuro/Computational_Neuroscience_-25--26/src/metrics/neural_data" --spectral_loss_coeff $spectral_loss_coeff $more_args