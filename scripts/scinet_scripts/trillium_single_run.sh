#!/bin/bash
#SBATCH --job-name=additional_simclr_runs
#SBATCH --time 16:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=additional_simclr_runs_%j.txt
#SBATCH --nodes=1
